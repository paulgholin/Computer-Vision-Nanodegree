...
def make_data(N, num_landmarks, world_size, measurement_range, motion_noise, 
    ...
    while not complete:
        ...
        for k in range(N-1):
            ...
            # move
            while not r.move(dx, dy): # r.move(dx, dy) will update x, y of robot
            ...
            """
            Z = [[i, dx, dy],]: relative position (dx and dy) between robot and ith landmark
            [dx, dy]: displacement of robot
            """
            data.append([Z, [dx, dy]]) 
